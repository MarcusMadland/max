...
///
#define BGFX_WINDOW_FLAG_NONE					  UINT32_C(0x00000000) //!<
#define BGFX_WINDOW_FLAG_ASPECT_RATIO			  UINT32_C(0x00000001) //!< 
#define BGFX_WINDOW_FLAG_FRAME					  UINT32_C(0x00000002) //!<

///
#define BGFX_BODY_ALLOW_NONE			UINT8_C(0b000000) //!< No degrees of freedom are allowed. Note that this is not valid and will crash. Use a static body instead.
#define BGFX_BODY_ALLOW_ALL				UINT8_C(0b111111) //!< All degrees of freedom are allowed
#define BGFX_BODY_ALLOW_TRANSLATION_X	UINT8_C(0b000001) //!< Body can move in world space X axis
#define BGFX_BODY_ALLOW_TRANSLATION_Y	UINT8_C(0b000010) //!< Body can move in world space Y axis
#define BGFX_BODY_ALLOW_TRANSLATION_Z	UINT8_C(0b000100) //!< Body can move in world space Z axis
#define BGFX_BODY_ALLOW_ROTATION_X		UINT8_C(0b001000) //!< Body can rotate around world space X axis
#define BGFX_BODY_ALLOW_ROTATION_Y		UINT8_C(0b010000) //!< Body can rotate around world space Y axis
#define BGFX_BODY_ALLOW_ROTATION_Z		UINT8_C(0b100000) //!< Body can rotate around world space Z axis

/// Body can move in X, Y and Z axis and only rotate around Z axis
#define BGFX_BODY_CHARACTER (0 \
	| BGFX_BODY_ALLOW_TRANSLATION_X \
	| BGFX_BODY_ALLOW_TRANSLATION_Y \
	| BGFX_BODY_ALLOW_TRANSLATION_Z \
	) 

/// Body can only move in X and Y axis and rotate around Z axis
#define BGFX_BODY_PLANE2D (0 \
	| BGFX_BODY_ALLOW_TRANSLATION_X \
	| BGFX_BODY_ALLOW_TRANSLATION_Y \
	| BGFX_BODY_ALLOW_TRANSLATION_Z \
	)
