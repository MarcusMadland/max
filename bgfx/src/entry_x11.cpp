...
#if BGFX_CONFIG_USE_NATIVE && (BX_PLATFORM_LINUX || BX_PLATFORM_RPI)
...
#define JS_EVENT_INIT   0x80 /* initial state of device */
	...
	struct EntryContext
	{
		...
		Display* m_display;
		Window m_window[BGFX_CONFIG_MAX_WINDOWS];
...
#endif // BGFX_CONFIG_USE_NATIVE && (BX_PLATFORM_LINUX || BX_PLATFORM_RPI)
