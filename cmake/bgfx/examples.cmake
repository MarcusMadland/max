...
function(add_example ARG_NAME)
	...
	target_link_libraries(example-${ARG_NAME} PUBLIC bgfx bx bimg bimg_decode mink jolt meshoptimizer)
	configure_debugging(example-${ARG_NAME} WORKING_DIR ${BGFX_DIR}/examples/runtime)
	
	target_include_directories(
		example-${ARG_NAME} PUBLIC ${BGFX_DIR}/3rdparty/ 
	)
	...
	if(BGFX_BUILD_EXAMPLES)
		if(IOS OR WIN32)
			...
			add_custom_command(
				TARGET example-${ARG_NAME}
				COMMAND ${CMAKE_COMMAND} -E create_symlink ${BGFX_DIR}/examples/runtime/motions
