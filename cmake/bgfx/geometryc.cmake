...
target_include_directories(geometryc PRIVATE ${BGFX_DIR}/3rdparty ${MINK_DIR}/include)

target_link_libraries(geometryc PRIVATE bx bgfx bgfx-vertexlayout meshoptimizer)

# @todo Do similar to bgfx.cmake instead.
set(CMAKE_MODULE_PATH ${BGFX_DIR}/../cmake/modules)
find_package(Fbx 2016)
if (Fbx_FOUND)
    target_compile_definitions(geometryc PRIVATE BGFX_GEOMETRYC_FBX_COMPILER)
