...
namespace max { namespace spirv
{
	...
	max::TextureComponentType::Enum SpirvCrossBaseTypeToFormatType(spirv_cross::SPIRType::BaseType spirvBaseType, bool depth)
	{
		if (depth)
			return max::TextureComponentType::Depth;

		switch (spirvBaseType)
		{
		case spirv_cross::SPIRType::Float:
			return max::TextureComponentType::Float;
		case spirv_cross::SPIRType::Int:
			return max::TextureComponentType::Int;
		case spirv_cross::SPIRType::UInt:
			return max::TextureComponentType::Uint;
		default:
		    return max::TextureComponentType::Float;
		}
	}

	max::TextureDimension::Enum SpirvDimToTextureViewDimension(spv::Dim _dim, bool _arrayed)
	{
		switch (_dim)
		{
		case spv::Dim::Dim1D:
			return max::TextureDimension::Dimension1D;
		case spv::Dim::Dim2D:
			return _arrayed
				? max::TextureDimension::Dimension2DArray
				: max::TextureDimension::Dimension2D
				;
		case spv::Dim::Dim3D:
			return max::TextureDimension::Dimension3D;
		case spv::Dim::DimCube:
			return _arrayed
				? max::TextureDimension::DimensionCubeArray
				: max::TextureDimension::DimensionCube
				;
		default:
			BX_ASSERT(false, "Unknown texture dimension %d", _dim);
			return max::TextureDimension::Dimension2D;
		}
	}

	static max::TextureFormat::Enum s_textureFormats[] =
	{
		max::TextureFormat::Unknown,   // spv::ImageFormatUnknown = 0
		max::TextureFormat::RGBA32F,   // spv::ImageFormatRgba32f = 1
		max::TextureFormat::RGBA16F,   // spv::ImageFormatRgba16f = 2
		max::TextureFormat::R32F,      // spv::ImageFormatR32f = 3
		max::TextureFormat::RGBA8,     // spv::ImageFormatRgba8 = 4
		max::TextureFormat::RGBA8S,    // spv::ImageFormatRgba8Snorm = 5
		max::TextureFormat::RG32F,     // spv::ImageFormatRg32f = 6
		max::TextureFormat::RG16F,     // spv::ImageFormatRg16f = 7
		max::TextureFormat::RG11B10F,  // spv::ImageFormatR11fG11fB10f = 8
		max::TextureFormat::R16F,      // spv::ImageFormatR16f = 9
		max::TextureFormat::RGBA16,    // spv::ImageFormatRgba16 = 10
		max::TextureFormat::RGB10A2,   // spv::ImageFormatRgb10A2 = 11
		max::TextureFormat::RG16,      // spv::ImageFormatRg16 = 12
		max::TextureFormat::RG8,       // spv::ImageFormatRg8 = 13
		max::TextureFormat::R16,       // spv::ImageFormatR16 = 14
		max::TextureFormat::R8,        // spv::ImageFormatR8 = 15
		max::TextureFormat::RGBA16S,   // spv::ImageFormatRgba16Snorm = 16
		max::TextureFormat::RG16S,     // spv::ImageFormatRg16Snorm = 17
		max::TextureFormat::RG8S,      // spv::ImageFormatRg8Snorm = 18
		max::TextureFormat::R16S,      // spv::ImageFormatR16Snorm = 19
		max::TextureFormat::R8S,       // spv::ImageFormatR8Snorm = 20
		max::TextureFormat::RGBA32I,   // spv::ImageFormatRgba32i = 21
		max::TextureFormat::RGBA16I,   // spv::ImageFormatRgba16i = 22
		max::TextureFormat::RGBA8I,    // spv::ImageFormatRgba8i = 23
		max::TextureFormat::R32I,      // spv::ImageFormatR32i = 24
		max::TextureFormat::RG32I,     // spv::ImageFormatRg32i = 25
		max::TextureFormat::RG16I,     // spv::ImageFormatRg16i = 26
		max::TextureFormat::RG8I,      // spv::ImageFormatRg8i = 27
		max::TextureFormat::R16I,      // spv::ImageFormatR16i = 28
		max::TextureFormat::R8I,       // spv::ImageFormatR8i = 29
		max::TextureFormat::RGBA32U,   // spv::ImageFormatRgba32ui = 30
		max::TextureFormat::RGBA16U,   // spv::ImageFormatRgba16ui = 31
		max::TextureFormat::RGBA8U,    // spv::ImageFormatRgba8ui = 32
		max::TextureFormat::R32U,      // spv::ImageFormatR32ui = 33
		max::TextureFormat::Unknown,   // spv::ImageFormatRgb10a2ui = 34
		max::TextureFormat::RG32U,     // spv::ImageFormatRg32ui = 35
		max::TextureFormat::RG16U,     // spv::ImageFormatRg16ui = 36
		max::TextureFormat::RG8U,      // spv::ImageFormatRg8ui = 37
		max::TextureFormat::R16U,      // spv::ImageFormatR16ui = 38
		max::TextureFormat::R8U,       // spv::ImageFormatR8ui = 39
		max::TextureFormat::Unknown,   // spv::ImageFormatR64ui = 40
		max::TextureFormat::Unknown,   // spv::ImageFormatR64i = 41
	};
	...
	BX_STATIC_ASSERT(max::Attrib::Count == BX_COUNTOF(s_attribName) );

	max::Attrib::Enum toAttribEnum(const bx::StringView& _name)
	{
		for (uint8_t ii = 0; ii < Attrib::Count; ++ii)
		{
			if (0 == bx::strCmp(s_attribName[ii], _name) )
			{
				return max::Attrib::Enum(ii);
			}
		}

		return max::Attrib::Count;
	}
	...
	static const char* s_samplerTypes[] =
	{
		...
		"MaxSampler2DArray",
		"MaxSampler2DShadow",
		"MaxSampler2DArrayShadow",
		"MaxSampler3D",
		"MaxISampler3D",
		"MaxUSampler3D",
		"MaxSamplerCube",
		"MaxSamplerCubeShadow",
		"MaxSampler2DMS",
	};
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					{
						max::Attrib::Enum attr = toAttribEnum(program->getAttributeName(ii) );
						if (max::Attrib::Count != attr)
						{
							bx::write(_shaderWriter, max::attribToId(attr), &err);
						}
						else
						{
