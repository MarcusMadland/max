...
#if MAX_CONFIG_USE_NATIVE && (BX_PLATFORM_LINUX || BX_PLATFORM_RPI)
...
namespace max
{
	static const char* s_applicationName  = "MAX";
	static const char* s_applicationClass = "max";
...
#define JS_EVENT_INIT   0x80 /* initial state of device */
	...
	struct EntryContext
	{
		...
		Display* m_display;
		Window m_window[MAX_CONFIG_MAX_WINDOWS];
...
#endif // MAX_CONFIG_USE_NATIVE && (BX_PLATFORM_LINUX || BX_PLATFORM_RPI)
