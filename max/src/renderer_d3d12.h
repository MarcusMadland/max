...
#ifndef MAX_RENDERER_D3D12_H_HEADER_GUARD
#define MAX_RENDERER_D3D12_H_HEADER_GUARD
...
#if MAX_CONFIG_DEBUG_ANNOTATION && !BX_PLATFORM_LINUX
...
extern PFN_PIX_GET_THREAD_INFO      max_PIXGetThreadInfo;
extern PFN_PIX_EVENTS_REPLACE_BLOCK max_PIXEventsReplaceBlock;

#		define PIXGetThreadInfo      max_PIXGetThreadInfo
#		define PIXEventsReplaceBlock max_PIXEventsReplaceBlock
#	else
extern "C" struct PIXEventsThreadInfo* WINAPI max_PIXGetThreadInfo();
extern "C" uint64_t                    WINAPI max_PIXEventsReplaceBlock(bool _getEarliestTime);
...
namespace max { namespace d3d12
{
	...
	struct FrameBufferD3D12
	{
		FrameBufferD3D12()
			...
			, m_needPresent(false)
		{
			m_depth.idx = max::kInvalidHandle;
		}
	...
	struct BatchD3D12
	{
		...
		{
			D3D12_VERTEX_BUFFER_VIEW vbv[MAX_CONFIG_MAX_VERTEX_STREAMS + 1 /* instanced buffer */];
...
} /* namespace d3d12 */ } // namespace max

#endif // MAX_RENDERER_D3D12_H_HEADER_GUARD
