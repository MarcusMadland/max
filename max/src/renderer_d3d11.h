...
#ifndef MAX_RENDERER_D3D11_H_HEADER_GUARD
#define MAX_RENDERER_D3D11_H_HEADER_GUARD

#define USE_D3D11_DYNAMIC_LIB    (BX_PLATFORM_LINUX || BX_PLATFORM_WINDOWS)

#if !USE_D3D11_DYNAMIC_LIB
#   undef  MAX_CONFIG_DEBUG_ANNOTATION
#   define MAX_CONFIG_DEBUG_ANNOTATION 0
...
#define MAX_D3D11_BLEND_STATE_MASK (0   \
...
namespace max { namespace d3d11
{
	...
	struct FrameBufferD3D11
	{
		...
		ID3D11RenderTargetView*    m_rtv[MAX_CONFIG_MAX_FRAME_BUFFER_ATTACHMENTS-1];
		ID3D11UnorderedAccessView* m_uav[MAX_CONFIG_MAX_FRAME_BUFFER_ATTACHMENTS-1];
		ID3D11ShaderResourceView*  m_srv[MAX_CONFIG_MAX_FRAME_BUFFER_ATTACHMENTS-1];
...
#endif // MAX_RENDERER_D3D11_H_HEADER_GUARD
