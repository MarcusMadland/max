...
#if MAX_CONFIG_USE_NATIVE && BX_PLATFORM_ANDROID
...
namespace max
{
	...
	struct EntryContext
	{
		...
		{
			EntryContext* self = (EntryContext*)_app->userData;
			self->onAppCmd(_cmd);
		}
	...
	int32_t MainThreadEntry::threadFunc(bx::Thread* _thread, void* _userData)
	{
		...
		int32_t result = chdir("/sdcard/max/examples/runtime");
		BX_ASSERT(0 == result
...
#endif // MAX_CONFIG_USE_NATIVE && BX_PLATFORM_ANDROID
