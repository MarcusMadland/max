...
#if MAX_CONFIG_RENDERER_OPENGL || !(MAX_CONFIG_RENDERER_OPENGLES < 30)
...
#	endif // MAX_CONFIG_RENDERER_OPENGLES && MAX_CONFIG_RENDERER_OPENGLES < 30
#endif // !MAX_CONFIG_RENDERER_OPENGL
