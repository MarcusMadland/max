...
#ifndef MAX_COMPUTE_H_HEADER_GUARD
#define MAX_COMPUTE_H_HEADER_GUARD

#include "max_shader.sh"

#ifndef __cplusplus

#if MAX_SHADER_LANGUAGE_HLSL > 0 && MAX_SHADER_LANGUAGE_HLSL < 400
#	error "Compute is not supported!"
#endif // MAX_SHADER_LANGUAGE_HLSL

#if MAX_SHADER_LANGUAGE_METAL || MAX_SHADER_LANGUAGE_SPIRV
#	define FORMAT(_format) [[spv::format_ ## _format]]
#	define WRITEONLY [[spv::nonreadable]]
#else
#	define FORMAT(_format)
#	define WRITEONLY
#endif // MAX_SHADER_LANGUAGE_METAL || MAX_SHADER_LANGUAGE_SPIRV
...
#endif // MAX_COMPUTE_H_HEADER_GUARD
