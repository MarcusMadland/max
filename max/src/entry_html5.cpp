...
namespace max
{
	...
	EM_BOOL EntryContext::mouseCb(int32_t _eventType, const EmscriptenMouseEvent* _event, void* _userData)
	{
		BX_UNUSED(_userData);
	...
	EM_BOOL EntryContext::wheelCb(int32_t _eventType, const EmscriptenWheelEvent* _event, void* _userData)
	{
		BX_UNUSED(_userData);
	...
	EM_BOOL EntryContext::keyCb(int32_t _eventType, const EmscriptenKeyboardEvent* _event, void* _userData)
	{
		BX_UNUSED(_userData);
	...
	EM_BOOL EntryContext::resizeCb(int32_t _eventType, const EmscriptenUiEvent* _event, void* _userData)
	{
		BX_UNUSED(_eventType, _event, _userData);
		return false;
	}

	EM_BOOL EntryContext::canvasResizeCb(int32_t _eventType, const void* _reserved, void* _userData)
	{
		BX_UNUSED(_eventType, _reserved, _userData);
		return false;
	}

	EM_BOOL EntryContext::focusCb(int32_t _eventType, const EmscriptenFocusEvent* _event, void* _userData)
	{
