...
#if (MAX_CONFIG_RENDERER_OPENGLES || MAX_CONFIG_RENDERER_OPENGL)
...
namespace max { namespace gl
{
	...
	BX_STATIC_ASSERT(MAX_CONFIG_MAX_INSTANCE_DATA_COUNT == BX_COUNTOF(s_instanceDataName) );
...
#if MAX_CONFIG_RENDERER_OPENGL >= 40 || MAX_CONFIG_RENDERER_OPENGLES
...
#undef $A
	...
	static Extension s_extension[] =
	{
		...
		{ "ARB_clip_control",                         MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
		{ "ARB_compute_shader",                       MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
		{ "ARB_conservative_depth",                   MAX_CONFIG_RENDERER_OPENGL >= 42, true  },
		{ "ARB_copy_image",                           MAX_CONFIG_RENDERER_OPENGL >= 42, true  },
		{ "ARB_debug_label",                          false,                             true  },
		{ "ARB_debug_output",                         MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
		{ "ARB_depth_buffer_float",                   MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_depth_clamp",                          MAX_CONFIG_RENDERER_OPENGL >= 32, true  },
		{ "ARB_draw_buffers_blend",                   MAX_CONFIG_RENDERER_OPENGL >= 40, true  },
		{ "ARB_draw_indirect",                        MAX_CONFIG_RENDERER_OPENGL >= 40, true  },
		{ "ARB_draw_instanced",                       MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_ES3_compatibility",                    MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
		{ "ARB_framebuffer_object",                   MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "ARB_framebuffer_sRGB",                     MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "ARB_get_program_binary",                   MAX_CONFIG_RENDERER_OPENGL >= 41, true  },
		{ "ARB_half_float_pixel",                     MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "ARB_half_float_vertex",                    MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "ARB_indirect_parameters",                  MAX_CONFIG_RENDERER_OPENGL >= 46, true  },
		{ "ARB_instanced_arrays",                     MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_internalformat_query",                 MAX_CONFIG_RENDERER_OPENGL >= 42, true  },
		{ "ARB_internalformat_query2",                MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
		{ "ARB_invalidate_subdata",                   MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
		{ "ARB_map_buffer_range",                     MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "ARB_multi_draw_indirect",                  MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
		{ "ARB_multisample",                          false,                             true  },
		{ "ARB_occlusion_query",                      MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_occlusion_query2",                     MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_program_interface_query",              MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
		{ "ARB_provoking_vertex",                     MAX_CONFIG_RENDERER_OPENGL >= 32, true  },
		{ "ARB_sampler_objects",                      MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_seamless_cube_map",                    MAX_CONFIG_RENDERER_OPENGL >= 32, true  },
		{ "ARB_shader_bit_encoding",                  MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_shader_image_load_store",              MAX_CONFIG_RENDERER_OPENGL >= 42, true  },
		{ "ARB_shader_storage_buffer_object",         MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
		{ "ARB_shader_texture_lod",                   MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "ARB_shader_viewport_layer_array",          false,                             true  },
		{ "ARB_texture_compression_bptc",             MAX_CONFIG_RENDERER_OPENGL >= 44, true  },
		{ "ARB_texture_compression_rgtc",             MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "ARB_texture_cube_map_array",               MAX_CONFIG_RENDERER_OPENGL >= 40, true  },
		{ "ARB_texture_float",                        MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "ARB_texture_multisample",                  MAX_CONFIG_RENDERER_OPENGL >= 32, true  },
		{ "ARB_texture_rg",                           MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "ARB_texture_rgb10_a2ui",                   MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_texture_stencil8",                     false,                             true  },
		{ "ARB_texture_storage",                      MAX_CONFIG_RENDERER_OPENGL >= 42, true  },
		{ "ARB_texture_swizzle",                      MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_timer_query",                          MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		{ "ARB_uniform_buffer_object",                MAX_CONFIG_RENDERER_OPENGL >= 31, true  },
		{ "ARB_vertex_array_object",                  MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		...
		{ "EXT_bgra",                                 false,                             true  },
		{ "EXT_blend_color",                          MAX_CONFIG_RENDERER_OPENGL >= 31, true  },
		{ "EXT_blend_minmax",                         MAX_CONFIG_RENDERER_OPENGL >= 14, true  },
		{ "EXT_blend_subtract",                       MAX_CONFIG_RENDERER_OPENGL >= 14, true  },
		...
		{ "EXT_framebuffer_blit",                     MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "EXT_framebuffer_object",                   MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "EXT_framebuffer_sRGB",                     MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "EXT_gpu_shader4",                          MAX_CONFIG_RENDERER_OPENGL >= 31, true  },
		{ "EXT_multi_draw_indirect",                  false,                             true  }, // GLES3.1 extension.
		{ "EXT_occlusion_query_boolean",              false,                             true  }, // GLES2 extension.
		{ "EXT_packed_float",                         MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		...
		{ "EXT_texture_array",                        MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		{ "EXT_texture_compression_dxt1",             false,                             true  },
		{ "EXT_texture_compression_latc",             false,                             true  },
		{ "EXT_texture_compression_rgtc",             MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		...
		{ "EXT_texture_snorm",                        MAX_CONFIG_RENDERER_OPENGL >= 30, true  },
		...
		{ "EXT_timer_query",                          MAX_CONFIG_RENDERER_OPENGL >= 33, true  },
		...
		{ "KHR_debug",                                MAX_CONFIG_RENDERER_OPENGL >= 43, true  },
	...
	{
		const uint32_t mag = (_flags&MAX_SAMPLER_MAG_MASK)>>MAX_SAMPLER_MAG_SHIFT;
		const uint32_t min = (_flags&MAX_SAMPLER_MIN_MASK)>>MAX_SAMPLER_MIN_SHIFT;
		const uint32_t mip = (_flags&MAX_SAMPLER_MIP_MASK)>>MAX_SAMPLER_MIP_SHIFT;
	...
	{
		{ "NVIDIA Corporation",           MAX_PCI_ID_NVIDIA },
		{ "Advanced Micro Devices, Inc.", MAX_PCI_ID_AMD    },
		{ "Intel",                        MAX_PCI_ID_INTEL  },
		{ "ATI Technologies Inc.",        MAX_PCI_ID_AMD    },
		{ "ARM",                          MAX_PCI_ID_ARM    },
	};
	...
	struct RendererContextGL : public RendererContextI
	{
		RendererContextGL()
			...
			, m_readBackSupported(BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) )
			, m_vaoSupport(false)
			, m_samplerObjectSupport(false)
			, m_shadowSamplersSupport(false)
			, m_srgbWriteControlSupport(BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) )
			, m_borderColorSupport(BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) )
			...
			, m_msaaBlitProgram(0)
			, m_clearQuadColor(MAX_INVALID_HANDLE)
			, m_clearQuadDepth(MAX_INVALID_HANDLE)
		{
		...
		bool init(const Init& _init)
		{
...

			{
				...
				{
					m_gles3 = BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES >= 30);
				}
			}
...
#define GL_GET(_pname, _min) BX_TRACE("  " #_pname " %d (min: %d)", glGet(_pname), _min)
				BX_TRACE("Defaults:");
#if MAX_CONFIG_RENDERER_OPENGL >= 41 || MAX_CONFIG_RENDERER_OPENGLES
...
#endif // MAX_CONFIG_RENDERER_OPENGL >= 41 || MAX_CONFIG_RENDERER_OPENGLES
...
#undef GL_GET
			...
			if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES >= 31)
			...
			if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES)
			&&  0 == bx::strCmp(m_vendor, "Imagination Technologies")
			...
			if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL)
...

			{
				...
				bool etc2Supported = !!(MAX_CONFIG_RENDERER_OPENGLES >= 30)
				...
				if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES) )
				{
					if (m_gles3)
					{
						setTextureFormat(TextureFormat::R16F,    GL_R16F,    GL_RED,  0x140B /* == GL_HALF_FLOAT, but max overwrites it globally with GL_HALF_FLOAT_OES */);
						setTextureFormat(TextureFormat::RG16F,   GL_RG16F,   GL_RG,   0x140B /* == GL_HALF_FLOAT, but max overwrites it globally with GL_HALF_FLOAT_OES */);
						setTextureFormat(TextureFormat::RGBA16F, GL_RGBA16F, GL_RGBA, 0x140B /* == GL_HALF_FLOAT, but max overwrites it globally with GL_HALF_FLOAT_OES */);
					}
					else
					{
	...
	//				setTextureFormat(TextureFormat::RGBA16,  GL_RGBA16UI, GL_RGBA_INTEGER, GL_UNSIGNED_SHORT);
				...
				const bool computeSupport = false
					|| !!(MAX_CONFIG_RENDERER_OPENGLES >= 31)
				...
				for (uint32_t ii = 0; ii < TextureFormat::Count; ++ii)
				{
					...
					uint16_t supported = MAX_CAPS_FORMAT_TEXTURE_NONE;
					...
					supported |= computeSupport
						...
						? (MAX_CAPS_FORMAT_TEXTURE_IMAGE_READ | MAX_CAPS_FORMAT_TEXTURE_IMAGE_WRITE)
						: MAX_CAPS_FORMAT_TEXTURE_NONE
						;
				...
				g_caps.supported |= !!(MAX_CONFIG_RENDERER_OPENGL || m_gles3)
				...
				g_caps.supported |= m_blitSupported || BX_ENABLED(MAX_GL_CONFIG_BLIT_EMULATION)
					? MAX_CAPS_TEXTURE_BLIT
					: 0
					;

				g_caps.supported |= (m_readBackSupported || BX_ENABLED(MAX_GL_CONFIG_TEXTURE_READ_BACK_EMULATION) )
				...
				g_caps.supported |= false
					|| BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL >= 32)
					|| (m_gles3 && !BX_ENABLED(BX_PLATFORM_EMSCRIPTEN) && BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES >= 32) )
				...
				g_caps.limits.maxTextureLayers   = BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL >= 30) || BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES >= 30) || s_extension[Extension::EXT_texture_array].m_supported ? uint16_t(bx::max(glGet(GL_MAX_ARRAY_TEXTURE_LAYERS), 1) ) : 1;
				g_caps.limits.maxComputeBindings = computeSupport ? MAX_MAX_COMPUTE_BINDINGS : 0;
...
//				else
				...
				m_shadowSamplersSupport = !!(MAX_CONFIG_RENDERER_OPENGL || m_gles3)
					|| s_extension[Extension::EXT_shadow_samplers].m_supported
					;
				...
				m_depthTextureSupport = !!(MAX_CONFIG_RENDERER_OPENGL || m_gles3)
				...
				g_caps.supported |= 0
					| (m_atocSupport               ? MAX_CAPS_ALPHA_TO_COVERAGE      : 0)
					| (m_conservativeRasterSupport ? MAX_CAPS_CONSERVATIVE_RASTER    : 0)
					| (m_occlusionQuerySupport     ? MAX_CAPS_OCCLUSION_QUERY        : 0)
					| (m_depthTextureSupport       ? MAX_CAPS_TEXTURE_COMPARE_LEQUAL : 0)
					| (computeSupport              ? MAX_CAPS_COMPUTE                : 0)
					| (m_imageLoadStoreSupport     ? MAX_CAPS_IMAGE_RW               : 0)
					;
				...
				if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES) )
				{
					...
					s_textureAddress[MAX_SAMPLER_U_BORDER>>MAX_SAMPLER_U_SHIFT] = s_extension[Extension::NV_texture_border_clamp].m_supported
						? GL_CLAMP_TO_BORDER
						: GL_CLAMP_TO_EDGE
						;
				}
...
#if MAX_CONFIG_RENDERER_OPENGLES && (MAX_CONFIG_RENDERER_OPENGLES < 30)
...
#endif // MAX_CONFIG_RENDERER_OPENGLES < 30
				...
				if (m_gles3)
				{
					g_caps.supported |= MAX_CAPS_INSTANCING;
				}
				else
				{
					...
					if (0 == (g_caps.supported & MAX_CAPS_INSTANCING) )
					{
				...
				g_caps.supported |= BX_ENABLED(BX_PLATFORM_WINRT) ? MAX_CAPS_TRANSPARENT_BACKBUFFER : 0;
				...
				m_maxLabelLen = BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES >= 32) || BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL >= 43) || s_extension[Extension::KHR_debug].m_supported ? uint16_t(glGet(GL_MAX_LABEL_LENGTH) ) : 0;
		...
		{
			return MAX_RENDERER_OPENGL_NAME;
		}
		...
		void readTexture(TextureHandle _handle, void* _data, uint8_t _mip) override
		{
			...
			else if (BX_ENABLED(MAX_GL_CONFIG_TEXTURE_READ_BACK_EMULATION) )
			{
				const TextureGL& texture = m_textures[_handle.idx];
				const bool compressed    = bimg::isCompressed(bimg::TextureFormat::Enum(texture.m_textureFormat) );
				...
				if (!compressed)
				{
					...
					if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) || m_gles3)
					{
		...
		{
			m_maxAnisotropy = !!(_resolution.reset & MAX_RESET_MAXANISOTROPY)
			...
			{
				if (!!(_resolution.reset & MAX_RESET_DEPTH_CLAMP) )
				{
			...
			{
				uint32_t flags = _resolution.reset & (~MAX_RESET_INTERNAL_FORCE);
		...
		uint32_t setFrameBuffer(FrameBufferHandle _fbh, uint32_t _height, uint16_t _discard = MAX_CLEAR_NONE, bool _msaa = true)
		{
			if (isValid(m_fbh)
			&&  m_fbh.idx != _fbh.idx)
			{
			...
			if (m_srgbWriteControlSupport)
			{
				if (0 == m_currentFbo)
				{
					if (0 != (m_resolution.reset & MAX_RESET_SRGB_BACKBUFFER) )
					{
		...
		void createMsaaFbo(uint32_t _width, uint32_t _height, uint32_t _msaa)
		{
			...
			{
				GLenum storageFormat = m_resolution.reset & MAX_RESET_SRGB_BACKBUFFER
					? GL_SRGB8_ALPHA8
					: GL_RGBA8
					;

				GLenum attachment = BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) || m_gles3
		...
		void blitMsaaFbo()
		{
			...
			&&  0 != m_msaaBackBufferFbo)
			{
				...
				const GLenum filter = BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) || !m_gles3
					? GL_NEAREST
					: GL_LINEAR
					;
		...
		void setRenderContextSize(uint32_t _width, uint32_t _height, uint32_t _flags = 0)
		{
			...
			else
			{
				...
				uint32_t msaa = (_flags&MAX_RESET_MSAA_MASK)>>MAX_RESET_MSAA_SHIFT;
		...
		void setSamplerState(uint32_t _stage, uint32_t _numMips, uint32_t _flags, const float _rgba[4])
		{
			...
			if (0 == (MAX_SAMPLER_INTERNAL_DEFAULT & _flags) )
			{
				const uint32_t index = (_flags & MAX_SAMPLER_BORDER_COLOR_MASK) >> MAX_SAMPLER_BORDER_COLOR_SHIFT;

				_flags &= ~MAX_SAMPLER_RESERVED_MASK;
				_flags &= MAX_SAMPLER_BITS_MASK;
				_flags |= _numMips<<MAX_SAMPLER_RESERVED_SHIFT;
				...
				if (UINT32_MAX == sampler)
				{
					...
					GL_CHECK(glSamplerParameteri(sampler
						, GL_TEXTURE_WRAP_S
						, s_textureAddress[(_flags&MAX_SAMPLER_U_MASK)>>MAX_SAMPLER_U_SHIFT]
						) );
					GL_CHECK(glSamplerParameteri(sampler
						, GL_TEXTURE_WRAP_T
						, s_textureAddress[(_flags&MAX_SAMPLER_V_MASK)>>MAX_SAMPLER_V_SHIFT]
						) );
					GL_CHECK(glSamplerParameteri(sampler
						, GL_TEXTURE_WRAP_R
						, s_textureAddress[(_flags&MAX_SAMPLER_W_MASK)>>MAX_SAMPLER_W_SHIFT]
						) );
					...
					if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) )
					{
						GL_CHECK(glSamplerParameterf(sampler, GL_TEXTURE_LOD_BIAS, float(MAX_CONFIG_MIP_LOD_BIAS) ) );
					}
					...
					if (0 != (_flags & (MAX_SAMPLER_MIN_ANISOTROPIC|MAX_SAMPLER_MAG_ANISOTROPIC) )
		...
		void clearQuad(ClearQuad& _clearQuad, const Rect& _rect, const Clear& _clear, uint32_t _height, const float _palette[][4])
		{
			...
			if (1 == numMrt)
			{
				...
				if (MAX_CLEAR_COLOR & _clear.m_flags)
				{
					...
					{
						uint8_t index = (uint8_t)bx::uint32_min(MAX_CONFIG_MAX_COLOR_PALETTE-1, _clear.m_index[0]);
				...
				if (MAX_CLEAR_DEPTH & _clear.m_flags)
				{
				...
				if (MAX_CLEAR_STENCIL & _clear.m_flags)
				{
			...
			else
			{
				...
				GLboolean colorMask = !!(MAX_CLEAR_COLOR & _clear.m_flags);
				...
				{
					const UniformRegInfo* infoClearColor = m_uniformReg.find("max_clear_color");
				...
				{
					const UniformRegInfo* infoClearDepth = m_uniformReg.find("max_clear_depth");
				...
				if (MAX_CLEAR_COLOR_USE_PALETTE & _clear.m_flags)
				{
					...
					{
						uint8_t index = (uint8_t)bx::uint32_min(MAX_CONFIG_MAX_COLOR_PALETTE-1, _clear.m_index[ii]);
		...
		IndexBufferGL m_indexBuffers[MAX_CONFIG_MAX_INDEX_BUFFERS];
		VertexBufferGL m_vertexBuffers[MAX_CONFIG_MAX_VERTEX_BUFFERS];
		ShaderGL m_shaders[MAX_CONFIG_MAX_SHADERS];
		ProgramGL m_program[MAX_CONFIG_MAX_PROGRAMS];
		TextureGL m_textures[MAX_CONFIG_MAX_TEXTURES];
		VertexLayout m_vertexLayouts[MAX_CONFIG_MAX_VERTEX_LAYOUTS];
		FrameBufferGL m_frameBuffers[MAX_CONFIG_MAX_FRAME_BUFFERS];
...
#undef GLENUM
	...
	void ProgramGL::init()
	{
		...
		GL_CHECK(glBindFragDataLocation(m_id, 0, "max_FragColor") );
#endif // MAX_CONFIG_RENDERER_OPENGL >= 31
		...
		for (uint32_t ii = 0, iiEnd = m_usedCount; ii < iiEnd; ++ii)
		{
			...
			if (-1 != loc)
			{
				if (UINT16_MAX != _layout.m_attributes[attr])
				{
					...
					if ( (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL >= 30) || s_renderGL->m_gles3)
					&&  !isFloat(type)
					&&  !normalized)
					{
	...
	bool TextureGL::init(GLenum _target, uint32_t _width, uint32_t _height, uint32_t _depth, uint8_t _numMips, uint64_t _flags)
	{
		...
		const bool srgb         = 0 != (m_flags&MAX_TEXTURE_SRGB);
		...
		if (renderTarget)
		{
			uint32_t msaaQuality = ( (m_flags&MAX_TEXTURE_RT_MSAA_MASK)>>MAX_TEXTURE_RT_MSAA_SHIFT);
			msaaQuality = bx::uint32_satsub(msaaQuality, 1);
			msaaQuality = bx::uint32_min(s_renderGL->m_maxMsaa, msaaQuality == 0 ? 0 : 1<<msaaQuality);
			const bool msaaSample = 0 != (m_flags&MAX_TEXTURE_MSAA_SAMPLE);
			...
			&&  !textureArray)
			{
				...
				else if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) || s_renderGL->m_gles3)
				{
	...
	void TextureGL::create(const Memory* _mem, uint64_t _flags, uint8_t _skip)
	{
		...
		if (bimg::imageParse(imageContainer, _mem->data, _mem->size) )
		{
			...
			const bool computeWrite = 0 != (_flags&MAX_TEXTURE_COMPUTE_WRITE);
			const bool srgb         = 0 != (_flags&MAX_TEXTURE_SRGB);
			const bool msaaSample   = 0 != (_flags&MAX_TEXTURE_MSAA_SAMPLE);
			uint32_t msaaQuality = ( (_flags&MAX_TEXTURE_RT_MSAA_MASK)>>MAX_TEXTURE_RT_MSAA_SHIFT);
			msaaQuality = bx::uint32_satsub(msaaQuality, 1);
			msaaQuality = bx::uint32_min(s_renderGL->m_maxMsaa, msaaQuality == 0 ? 0 : 1<<msaaQuality);
			...
			BX_TRACE("Texture%-4s %3d: %s %s(requested: %s), layers %d, %dx%dx%d%s."
				...
				, 0 != (m_flags&MAX_TEXTURE_RT_MASK) ? " (render target)" : ""
				);
	...
	{
		if (0 == (m_flags & MAX_SAMPLER_INTERNAL_SHARED)
		&&  0 != m_id)
		{
			GL_CHECK(glBindTexture(m_target, 0) );
	...
	{
		destroy();
		m_flags |= MAX_SAMPLER_INTERNAL_SHARED;
		m_id = (GLuint)_ptr;
	}
	...
	void TextureGL::update(uint8_t _side, uint8_t _mip, const Rect& _rect, uint16_t _z, uint16_t _depth, uint16_t _pitch, const Memory* _mem)
	{
		...
		const bool swizzle = true
			...
			&& !s_renderGL->m_textureSwizzleSupport
			;
		const bool unpackRowLength = !!MAX_CONFIG_RENDERER_OPENGL || s_extension[Extension::EXT_unpack_subimage].m_supported;
		const bool compressed      = bimg::isCompressed(bimg::TextureFormat::Enum(m_requestedFormat) );
		const bool convert         = false
		...
		&& !convert)
		{
			...
			const GLenum internalFmt = (0 != (m_flags & MAX_TEXTURE_SRGB) )
				? s_textureFormat[m_textureFormat].m_internalFmtSrgb
				: s_textureFormat[m_textureFormat].m_internalFmt
				;
	...
	void TextureGL::setSamplerState(uint32_t _flags, const float _rgba[4])
	{
		...
		const uint32_t flags = (0 != (MAX_SAMPLER_INTERNAL_DEFAULT & _flags) ? m_flags : _flags) & MAX_SAMPLER_BITS_MASK;
		...
		if (NULL != _rgba)
		{
			if (MAX_SAMPLER_U_BORDER == (flags & MAX_SAMPLER_U_BORDER)
			||  MAX_SAMPLER_V_BORDER == (flags & MAX_SAMPLER_V_BORDER)
			||  MAX_SAMPLER_W_BORDER == (flags & MAX_SAMPLER_W_BORDER) )
			{
				murmur.add(_rgba, 16);
				hasBorderColor = true;
			}
		...
		if (hash != m_currentSamplerHash)
		{
			...
			GL_CHECK(glTexParameteri(target, GL_TEXTURE_WRAP_S, s_textureAddress[(flags&MAX_SAMPLER_U_MASK)>>MAX_SAMPLER_U_SHIFT]) );
			GL_CHECK(glTexParameteri(target, GL_TEXTURE_WRAP_T, s_textureAddress[(flags&MAX_SAMPLER_V_MASK)>>MAX_SAMPLER_V_SHIFT]) );

			if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) || s_renderGL->m_gles3
			...
			{
				GL_CHECK(glTexParameteri(target, GL_TEXTURE_WRAP_R, s_textureAddress[(flags&MAX_SAMPLER_W_MASK)>>MAX_SAMPLER_W_SHIFT]) );
			}
			...
			if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) )
			{
				GL_CHECK(glTexParameterf(target, GL_TEXTURE_LOD_BIAS, float(MAX_CONFIG_MIP_LOD_BIAS) ) );
			}
			...
			if (0 != (flags & (MAX_SAMPLER_MIN_ANISOTROPIC|MAX_SAMPLER_MAG_ANISOTROPIC) )
			...
			{
				const uint32_t cmpFunc = (flags&MAX_SAMPLER_COMPARE_MASK)>>MAX_SAMPLER_COMPARE_SHIFT;
				if (0 == cmpFunc)
				{
	...
	{
		const uint32_t flags = 0 == (MAX_SAMPLER_INTERNAL_DEFAULT & _flags)
			? _flags
			: uint32_t(m_flags)
			;
		const uint32_t index = (flags & MAX_SAMPLER_BORDER_COLOR_MASK) >> MAX_SAMPLER_BORDER_COLOR_SHIFT;
	...
	void ShaderGL::create(const Memory* _mem)
	{
		...
		if (0 != m_id)
		{
			...
			&&  0 != bx::strCmp(code, "#version", 8) ) // #2000
			{
						...
						if (s_extension[Extension::EXT_frag_depth].m_supported)
						{
							bx::write(&writer
								, "#extension GL_EXT_frag_depth : enable\n"
								  "#define max_FragDepth gl_FragDepthEXT\n"
								, &err
								);
					...
					if (insertFragDepth)
					{
						...
						if (!entry.isEmpty() )
						{
							...
							if (!brace.isEmpty() )
							{
								...
								if (!block.isEmpty() )
								{
									strins(const_cast<char*>(brace.getPtr()+1), "\n  float max_FragDepth = 0.0;\n");
								}
							}
						}
					}

					// Replace all instances of gl_FragDepth with max_FragDepth.
				...
				else if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL)
					 &&  BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL <= 21) )
				{
					...
					if (130 <= version)
					{
						...
						if (!bx::findIdentifierMatch(code, "gl_FragData").isEmpty() )
						{
							...
							MAX_FATAL(0 != fragData, Fatal::InvalidShader, "Unable to find and patch gl_FragData!");
						}

						if (0 != fragData)
						{
							bx::write(&writer, &err, "out vec4 max_FragData[%d];\n", fragData);
							bx::write(&writer, "#define gl_FragData max_FragData\n", &err);
						}
						else if (!bx::findIdentifierMatch(code, "gl_FragColor").isEmpty() )
						{
							bx::write(&writer
								, "out vec4 max_FragColor;\n"
								  "#define gl_FragColor max_FragColor\n"
								, &err
								);
						}
					}
				...
				else if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL   >= 31)
					 ||  s_renderGL->m_gles3)
				{
					if (s_renderGL->m_gles3)
					{
					...
					if (m_type == GL_FRAGMENT_SHADER)
					{
						...
						bool patchedFragData = s_renderGL->m_gles3 && !bx::findIdentifierMatch(code, "max_FragData").isEmpty();
						...
						{
							if (bx::findIdentifierMatch(code, "max_FragColor").isEmpty() )
							{
								bx::write(&writer
									, "out vec4 max_FragColor;\n"
									  "#define gl_FragColor max_FragColor\n"
			...
			if (0 == compiled)
			{
				...
				m_id = 0;
				MAX_FATAL(false, max::Fatal::InvalidShader, "Failed to compile shader. %d: %s", compiled, log);
			}
			else if (BX_ENABLED(MAX_CONFIG_DEBUG)
	...
	void FrameBufferGL::postReset()
	{
		if (0 != m_fbo[0])
		{
			...
			GLenum buffers[MAX_CONFIG_MAX_FRAME_BUFFER_ATTACHMENTS];
			...
			if (0 == colorIdx && BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) )
			{
	...
	{
		GLenum buffers[MAX_CONFIG_MAX_FRAME_BUFFER_ATTACHMENTS+2];
		uint32_t idx = 0;

		if (MAX_CLEAR_NONE != (_flags & MAX_CLEAR_DISCARD_COLOR_MASK) )
		{
			for (uint32_t ii = 0, num = m_num; ii < num; ++ii)
			{
				if (MAX_CLEAR_NONE != (_flags & (MAX_CLEAR_DISCARD_COLOR_0<<ii) ) )
				{
		...
		uint32_t dsFlags = _flags & (MAX_CLEAR_DISCARD_DEPTH|MAX_CLEAR_DISCARD_STENCIL);
		if (MAX_CLEAR_NONE != dsFlags)
		{
			if (!BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES)
			&&  (MAX_CLEAR_DISCARD_DEPTH|MAX_CLEAR_DISCARD_STENCIL) == dsFlags)
			{
				buffers[idx++] = GL_DEPTH_STENCIL_ATTACHMENT;
			}
			else if (MAX_CLEAR_DISCARD_DEPTH == dsFlags)
			{
				buffers[idx++] = GL_DEPTH_ATTACHMENT;
			}
			else if (MAX_CLEAR_DISCARD_STENCIL == dsFlags)
			{
	...
	void OcclusionQueryGL::invalidate(OcclusionQueryHandle _handle)
	{
		...
		for (uint32_t ii = 0, num = m_control.available(); ii < num; ++ii)
		{
			...
			{
				query.m_handle.idx = max::kInvalidHandle;
			}
		}
	}
	...
	void RendererContextGL::submitBlit(BlitState& _bs, uint16_t _view)
	{
		...
		else if (BX_ENABLED(MAX_GL_CONFIG_BLIT_EMULATION) )
		{
			while (_bs.hasItem(_view) )
			{
				const BlitItem& bi = _bs.advance();
	...
	void RendererContextGL::submit(Frame* _render, ClearQuad& _clearQuad, TextVideoMemBlitter& _textVideoMemBlitter)
	{
		...
		MAX_GL_PROFILER_BEGIN_LITERAL("rendererSubmit", kColorView);
		...
		ProgramHandle boundProgram   = MAX_INVALID_HANDLE;
		SortKey key;
		...
		{
			const uint64_t pt = 0;
			primIndex = uint8_t(pt>>MAX_STATE_PT_SHIFT);
		}
		PrimInfo prim = s_primInfo[primIndex];

		GL_CHECK(glPolygonMode(GL_FRONT_AND_BACK
			, _render->m_debug&MAX_DEBUG_WIREFRAME
			? GL_LINE
			: GL_FILL
			) );
		...
		uint16_t discardFlags = MAX_CLEAR_NONE;
		...
		const bool computeSupported = false
			|| (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) && s_extension[Extension::ARB_compute_shader].m_supported)
			||  BX_ENABLED(MAX_CONFIG_RENDERER_OPENGLES >= 31)
			;
		...
		if (0 == (_render->m_debug&MAX_DEBUG_IFH) )
		{
			...
			for (int32_t item = 0; item < numItems;)
			{
				...
				if (viewChanged)
				{
					...
					setViewType(view, "  ");
					MAX_GL_PROFILER_BEGIN(view, kColorView);
					...
					discardFlags = clear.m_flags & MAX_CLEAR_DISCARD_MASK;

					if (MAX_CLEAR_NONE != (clear.m_flags & MAX_CLEAR_MASK) )
					{
				...
				if (isCompute)
				{
					if (!wasCompute)
					{
						...
						setViewType(view, "C");
						MAX_GL_PROFILER_END();
						MAX_GL_PROFILER_BEGIN(view, kColorCompute);
					}
					...
					if (computeSupported)
					{
						...
						if (0 != barrier)
						{
							...
							if (isValid(compute.m_indirectBuffer) )
							{
								...
								uintptr_t args = compute.m_startIndirect * MAX_CONFIG_DRAW_INDIRECT_STRIDE;
				...
				if (wasCompute)
				{
					...
					setViewType(view, " ");
					MAX_GL_PROFILER_END();
					MAX_GL_PROFILER_BEGIN(view, kColorDraw);
				}
				...
				if (resetState)
				{
					currentState.clear();
					currentState.m_scissor = !draw.m_scissor;
					changedFlags   = MAX_STATE_MASK;
					changedStencil = packStencil(MAX_STENCIL_MASK, MAX_STENCIL_MASK);
					currentState.m_stateFlags = newFlags;
					currentState.m_stencil    = newStencil;
				...
				if (0 != changedStencil)
				{
					if (0 != newStencil)
					{
						...
						uint8_t frontAndBack = bstencil != MAX_STENCIL_NONE && bstencil != unpackStencil(0, newStencil);

// 						uint32_t bchanged = unpackStencil(1, changedStencil);
// 						if (MAX_STENCIL_FUNC_RMASK_MASK & bchanged)
// 						{
// 							uint32_t wmask = (bstencil&MAX_STENCIL_FUNC_RMASK_MASK)>>MAX_STENCIL_FUNC_RMASK_SHIFT;
...
// 						}
						...
						for (uint8_t ii = 0, num = frontAndBack+1; ii < num; ++ii)
						{
							...
							if ( (MAX_STENCIL_TEST_MASK|MAX_STENCIL_FUNC_REF_MASK|MAX_STENCIL_FUNC_RMASK_MASK) & changed)
							{
								GLint ref = (stencil&MAX_STENCIL_FUNC_REF_MASK)>>MAX_STENCIL_FUNC_REF_SHIFT;
								GLint mask = (stencil&MAX_STENCIL_FUNC_RMASK_MASK)>>MAX_STENCIL_FUNC_RMASK_SHIFT;
								uint32_t func = (stencil&MAX_STENCIL_TEST_MASK)>>MAX_STENCIL_TEST_SHIFT;
								GL_CHECK(glStencilFuncSeparate(face, s_cmpFunc[func], ref, mask) );
							}

							if ( (MAX_STENCIL_OP_FAIL_S_MASK|MAX_STENCIL_OP_FAIL_Z_MASK|MAX_STENCIL_OP_PASS_Z_MASK) & changed)
							{
								uint32_t sfail = (stencil&MAX_STENCIL_OP_FAIL_S_MASK)>>MAX_STENCIL_OP_FAIL_S_SHIFT;
								uint32_t zfail = (stencil&MAX_STENCIL_OP_FAIL_Z_MASK)>>MAX_STENCIL_OP_FAIL_Z_SHIFT;
								uint32_t zpass = (stencil&MAX_STENCIL_OP_PASS_Z_MASK)>>MAX_STENCIL_OP_PASS_Z_SHIFT;
				...
				{
					if (MAX_STATE_FRONT_CCW & changedFlags)
					{
						GL_CHECK(glFrontFace( (MAX_STATE_FRONT_CCW & newFlags) ? GL_CCW : GL_CW) );
					}

					if (MAX_STATE_CULL_MASK & changedFlags)
					{
						if (MAX_STATE_CULL_CCW & newFlags)
						{
							GL_CHECK(glEnable(GL_CULL_FACE) );
							GL_CHECK(glCullFace(GL_BACK) );
						}
						else if (MAX_STATE_CULL_CW & newFlags)
						{
							GL_CHECK(glEnable(GL_CULL_FACE) );
					...
					if (MAX_STATE_WRITE_Z & changedFlags)
					{
						GL_CHECK(glDepthMask(!!(MAX_STATE_WRITE_Z & newFlags) ) );
					}

					if (MAX_STATE_DEPTH_TEST_MASK & changedFlags)
					{
						uint32_t func = (newFlags&MAX_STATE_DEPTH_TEST_MASK)>>MAX_STATE_DEPTH_TEST_SHIFT;
					...
					if (MAX_STATE_ALPHA_REF_MASK & changedFlags)
					{
						uint32_t ref = (newFlags&MAX_STATE_ALPHA_REF_MASK)>>MAX_STATE_ALPHA_REF_SHIFT;
						viewState.m_alphaRef = ref/255.0f;
					}

					if (BX_ENABLED(MAX_CONFIG_RENDERER_OPENGL) )
					{
						if ( (MAX_STATE_PT_POINTS|MAX_STATE_POINT_SIZE_MASK) & changedFlags)
						{
							float pointSize = (float)(bx::uint32_max(1, (newFlags&MAX_STATE_POINT_SIZE_MASK)>>MAX_STATE_POINT_SIZE_SHIFT) );
							GL_CHECK(glPointSize(pointSize) );
						}

						if (MAX_STATE_MSAA & changedFlags)
						{
							GL_CHECK(MAX_STATE_MSAA & newFlags
								? glEnable(GL_MULTISAMPLE)
								: glDisable(GL_MULTISAMPLE)
								);
						}

						if (MAX_STATE_LINEAA & changedFlags)
						{
							GL_CHECK(MAX_STATE_LINEAA & newFlags
						...
						&&  MAX_STATE_CONSERVATIVE_RASTER & changedFlags)
						{
							GL_CHECK(MAX_STATE_CONSERVATIVE_RASTER & newFlags
					...
					if ( (MAX_STATE_WRITE_A|MAX_STATE_WRITE_RGB) & changedFlags)
					{
						const GLboolean rr = !!(newFlags&MAX_STATE_WRITE_R);
						const GLboolean gg = !!(newFlags&MAX_STATE_WRITE_G);
						const GLboolean bb = !!(newFlags&MAX_STATE_WRITE_B);
						const GLboolean aa = !!(newFlags&MAX_STATE_WRITE_A);
					...
					||  blendFactor != draw.m_rgba)
					{
						if (m_atocSupport)
						{
							if (MAX_STATE_BLEND_ALPHA_TO_COVERAGE & newFlags)
							{
						...
						||  blendFactor != draw.m_rgba)
						{
							const bool enabled = !!(MAX_STATE_BLEND_MASK & newFlags);
							const bool independent = !!(MAX_STATE_BLEND_INDEPENDENT & newFlags)
								&& blendIndependentSupported
								;

							const uint32_t blend  = uint32_t( (newFlags&MAX_STATE_BLEND_MASK)>>MAX_STATE_BLEND_SHIFT);
							const uint32_t srcRGB = (blend    )&0xf;
							const uint32_t dstRGB = (blend>> 4)&0xf;
							const uint32_t srcA   = (blend>> 8)&0xf;
							const uint32_t dstA   = (blend>>12)&0xf;

							const uint32_t equ    = uint32_t( (newFlags&MAX_STATE_BLEND_EQUATION_MASK)>>MAX_STATE_BLEND_EQUATION_SHIFT);
					...
					const uint64_t pt = newFlags&MAX_STATE_PT_MASK;
					primIndex = uint8_t(pt>>MAX_STATE_PT_SHIFT);
					...
					if (0 != currentState.m_streamMask)
					{
						...
						if (isValid(draw.m_indirectBuffer) )
						{
							...
							if (isValid(draw.m_indexBuffer) )
							{
								...
								const bool hasIndex16 = 0 == (ib.m_flags & MAX_BUFFER_INDEX32);
								...
								uintptr_t args = draw.m_startIndirect * MAX_CONFIG_DRAW_INDIRECT_STRIDE;
			...
			{
				m_program[boundProgram.idx].unbindAttributes();
				boundProgram = MAX_INVALID_HANDLE;
			}
			...
			{
				if (0 != (m_resolution.reset & MAX_RESET_FLUSH_AFTER_RENDER) )
				{
					GL_CHECK(glFlush() );
				}
		...
		if (UINT32_MAX != frameQueryIdx)
		{
			...
			const TimerQueryGL::Result& result = m_gpuTimer.m_result[MAX_CONFIG_MAX_VIEWS];
		...
		{
			MAX_GL_PROFILER_BEGIN_LITERAL("debugstats", kColorFrame);
...
//				tvm.printf(10, pos++, 0x8b, " Uniform size: %7d, Max: %7d ", _render->m_uniformEnd, _render->m_uniformMax);
		...
		{
			MAX_GL_PROFILER_BEGIN_LITERAL("debugtext", kColorFrame);
...
#endif // (MAX_CONFIG_RENDERER_OPENGLES || MAX_CONFIG_RENDERER_OPENGL)
